...
public class User {
	...
	public boolean isUserHasItem() {
		return userHasItem;
	}

	public void setUserHasItem(boolean userHasItem) {
		this.userHasItem = userHasItem;
	}

	public boolean isDifferetItems() {
		return differetItems;
	}

	public void setDifferetItems(boolean differetItems) {
		this.differetItems = differetItems;
	}
